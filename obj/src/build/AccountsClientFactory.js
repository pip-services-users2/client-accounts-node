...
const AccountsMockClientV1_1 = require("../version1/AccountsMockClientV1");
...
class AccountsClientFactory extends pip_services3_components_nodex_1.Factory {
    constructor() {
        ...
        this.registerAsType(AccountsClientFactory.MockClientV1Descriptor, AccountsMockClientV1_1.AccountsMockClientV1);
